...
これはThe Unusual Skyblock v12.0.9 の主にX回路区域内にあるコマンド群について簡単にまとめたものです。なので、実際にX回路区域を飛び回りながらこれを読むことをおススメします。また、何か間違い等がありましたらtwitterにて連絡をいただけると嬉しいです(<https://twitter.com/Re16d5>)。
