---
title: エリア処理
tags: [コマンド,ディメンション,表示,通常世界,クラウディア,地下世界,テーブルマウンテン,ガリバーランド,トカルトコルデ,ネザー,煉獄,ネザーアスレ,エンド]
keywords: TUSB,The Unusual Skyblock,スカイブロック,コマンド,解析,X回路区域
last_updated: 2020/6/20
update: 2020-06-20 09:00:00 +0000
sidebar: mydoc_sidebar
permalink: command/xCircuit1/xCircuit1_areaProcessing.html
folder: xCircuit1
datatable4c: true
summary: エリア侵入時の演出やテーブルマウンテン、ネザーアスレ侵入時のエンダーチェスト処理を行う。
summaryDisable: true
---
